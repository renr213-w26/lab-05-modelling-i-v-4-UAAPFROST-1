...
b.  Plotting the data is a useful first step because it helps us quickly visualize trends, identify strong associations, and develop research questions. Create an appropriate plot displaying the relationship between `weight` and `habit`. In 2-3 sentences, discuss the relationships observed.
    ...
    Both groups of children, regardless of maternal smoking habits, seem to show very similar mean birth weights, although the smoking group show slightly lower mean birth weights. The group of children born to mothers who smoke seems to show a slightly wider range in birth weights when compared to non-smoking mothers.
